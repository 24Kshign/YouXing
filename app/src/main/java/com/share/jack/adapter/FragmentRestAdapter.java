 ...
 * Copyright:1.0
 */
public class FragmentRestAdapter extends BaseAdapter {

    private List<FragmentRestBean> mList;
    private LayoutInflater mInflater;
    private Context mContext;

    public FragmentRestAdapter(Context mContext, List<FragmentRestBean> mList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.item_rest_list, null);
            holder.ivImage = (ImageView) convertView.findViewById(R.id.irl_iv_image);
            holder.tvContent = (TextView) convertView.findViewById(R.id.irl_tv_content);
