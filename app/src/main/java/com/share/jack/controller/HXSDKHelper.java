package com.share.jack.controller;
...
import com.share.jack.model.DefaultHXSDKModel;
import com.share.jack.model.HXNotifier;
import com.share.jack.model.HXSDKModel;
 ...
 * 不过继承类需要根据要求求提供相应的函数，尤其是提供一个{}. 所以请实现abstract protected HXSDKModel createModel();
...
public abstract class HXSDKHelper {
    ...
    /**
     * init flag: activity_chat_list if the sdk has been inited before, we don't need to init again
     */
