...
import com.share.jack.parse.ParseManager;
import com.share.jack.utils.HXPreferenceUtils;
...
public class UserProfileManager {
	...
	/**
	 * init flag: activity_chat_list if the sdk has been inited before, we don't need to init
	 * again
	 */
